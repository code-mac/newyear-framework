...
public class ReflectionUtils {
     ...
     * @throws NullArgumentException    specified class or genetic is null.
    ...
    public static Class<?>[] getGenericParameters(Class<?> aClass, Class<?> aGeneric) {
        Validation.requireNonNull(aClass, "Must specified class");
        Validation.requireNonNull(aClass, "Must specified a generic type");
